...
// Constants
const BASE_URL = process.env.BASE_URL_SDK ?? "https://eks-subscription-api-lumen-service.epayco.io",
    BASE_URL_SECURE = process.env.SECURE_URL_SDK ??"https://eks-rest-recaudo-service.epayco.io",
    ENTORNO = process.env.ENTORNO_SDK ?? "/restpagos",
    BASE_URL_APIFY = process.env.BASE_URL_APIFY ?? "https://eks-apify-service.epayco.io"
