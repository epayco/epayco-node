...
// Constants
const BASE_URL = process.env.BASE_URL_SDK ?? "https://api.secure.epayco.io",
    BASE_URL_SECURE = process.env.SECURE_URL_SDK ??"https://secure2.epayco.io",
    ENTORNO = process.env.ENTORNO_SDK ?? "/restpagos",
    BASE_URL_APIFY = process.env.BASE_URL_APIFY ?? "https://apify.epayco.io"
