...
// Constants
const BASE_URL = getenv("BASE_URL_SDK", "https://api.secure.payco.co"),
    BASE_URL_SECURE = getenv("SECURE_URL_SDK", "https://secure.payco.co"),
    BASE_URL_APIFY = getenv("BASE_URL_APIFY", "https://apify.epayco.co");
