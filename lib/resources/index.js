...
// Constants
const BASE_URL = process.env.BASE_URL_SDK ?? "https://api-green.secure.payco.co",
    BASE_URL_SECURE = process.env.SECURE_URL_SDK ??"https://secure-green.payco.co/restpagos",
    ENTORNO = process.env.ENTORNO_SDK ?? "/restpagos",
    BASE_URL_APIFY = process.env.BASE_URL_APIFY ?? "https://apify-green.epayco.co"
