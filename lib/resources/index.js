...
// Constants
const BASE_URL = process.env.BASE_URL_SDK ? process.env.BASE_URL_SDK : "https://api.secure.epayco.io",
    BASE_URL_SECURE = process.env.SECURE_URL_SDK ? process.env.SECURE_URL_SDK :"https://secure2.epayco.io/restpagos",
